...
export const Route = createFileRoute("/_authenticated/admin/ai-analysis")({
  head: () => ({ meta: [{ title: "AI Analysis Dashboard — APEX AI" }] }),
  component: () => (
    <AdminLayout>
      <PageHeader 
        title="AI-Powered Student Analysis" 
      ...
      <ContentContainer>
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-500 leading-relaxed">
            This page will display dashboard analytics for smart automated summaries.
          </p>
        </div>
      </ContentContainer>
    </AdminLayout>
