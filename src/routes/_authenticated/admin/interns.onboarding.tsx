...
export const Route = createFileRoute("/_authenticated/admin/interns/onboarding")({
  head: () => ({ meta: [{ title: "Intern Onboarding Management — APEX AI" }] }),
  component: AdminOnboardingInterns,
});
...
function AdminOnboardingInterns() {
