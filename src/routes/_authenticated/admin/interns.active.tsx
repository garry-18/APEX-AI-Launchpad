...
export const Route = createFileRoute("/_authenticated/admin/interns/active")({
  head: () => ({ meta: [{ title: "Active Interns Management — APEX AI" }] }),
  component: AdminActiveInterns,
});
