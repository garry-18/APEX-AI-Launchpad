...
export const Route = createFileRoute("/_authenticated/admin/community/post-generator")({
          ...
          {generatedPost ? (
            <div className="bg-white border border-gray-150 rounded-3xl p-6 space-y-6 text-xs text-gray-700">
              <div className="border-b border-gray-100 pb-3 flex justify-between items-center">
                ...
                <button onClick={handleCopy} className="p-2 hover:bg-gray-100 rounded-xl text-gray-650 flex items-center gap-1.5 font-bold">
