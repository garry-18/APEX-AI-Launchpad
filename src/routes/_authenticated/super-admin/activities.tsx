...
export const Route = createFileRoute("/_authenticated/super-admin/activities")({
  head: () => ({ meta: [{ title: "Super Admin Activities Management & Audit — APEX AI" }] }),
  component: SuperAdminActivitiesManagement,
});
...
function SuperAdminActivitiesManagement() {
  ...
  return (
    <AdminLayout>
      <PageHeader 
        title="Super Admin Activities Management" 
                ...
                <tbody className="divide-y divide-gray-100">
                  {templates.map((temp) => (
                    <tr key={temp.id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="py-3.5 px-4 font-semibold text-gray-655">{temp.problemStatement}</td>
