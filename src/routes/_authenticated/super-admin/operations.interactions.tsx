...
export const Route = createFileRoute("/_authenticated/super-admin/operations/interactions")({
  head: () => ({ meta: [{ title: "Super Admin 1-to-1 Interaction Management — APEX AI" }] }),
  component: SuperAdminInteractionsManagement,
});
...
function SuperAdminInteractionsManagement() {
  ...
  return (
    <AdminLayout>
      <PageHeader 
        title="Super Admin 1-to-1 Interactions Control" 
                      ...
                      {sub.interviewStatus === "Waiting" && (
                        <>
                          <button 
                            ...
                            className="px-2.5 py-1.5 bg-gray-50 hover:bg-gray-100 rounded-lg text-[9px] font-black text-gray-655"
                          >
                            Skip Review
                          </button>
                          <button 
