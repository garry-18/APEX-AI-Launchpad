...
export const Route = createFileRoute("/_authenticated/super-admin/lms")({
  head: () => ({ meta: [{ title: "Super Admin LMS Learning Analytics — APEX AI" }] }),
  component: SuperAdminLMSMonitoring,
});
...
function SuperAdminLMSMonitoring() {
  ...
  return (
    <AdminLayout>
      <PageHeader 
        title="Super Admin LMS Monitoring" 
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredStudents.map((s) => (
                <tr key={s.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="py-3.5 px-4 font-semibold text-gray-855">{s.college}</td>
